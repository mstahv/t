...
No extensive knowledge of even Java is needed to get started, only basic programming skills are required. Although the tutorial is built for
...
existing Java based backend. We'll cover basic Vaadin development and you
...
mode, but it often helps you figure out what is happening in your
application.
...
You can now save your changes to the file and verify your changes from your browser.
...
It is now a good place to save your changes and try them in your browser.
...
slow motion to better follow what is being done on the video. Feel free to get creative!
...
you should see your CustomerForm next to the grid listing your
existing entities.
